# Modern Ruby Features (4.x+)

## Pattern Matching (Ruby 4.x+)
...
## Ractors (Ruby 4.x+) - True Parallelism
...
```ruby
# Ruby 4.x+ allows setting a fiber scheduler per thread
