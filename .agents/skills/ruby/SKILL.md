---
name: ruby
description: Use when writing, reviewing, or debugging pure Ruby code — idiomatic patterns, modern 4.x+ features (pattern matching, Data.define, endless methods), error handling conventions (raise vs fail, result objects), memoization, and performance idioms. Use RSpec for tests. For code style use sandi-metz-rules.
---
...
Opinionated Ruby conventions and idioms for writing idiomatic Ruby 4.x+ code. Focuses on patterns agents miss by default — the Weirich raise/fail distinction, safe nil-aware memoization, result objects over exceptions for expected failures, and performance-conscious enumeration.
